...
while(have_posts()){
    ...
    <div class="jumbotron missionJumbotron" style="background-image: url(<?php echo get_theme_file_uri('images/conversation.jpg'); ?>);">
  ...
  <div class="fluid-container container--narrow page-section">
    ...
    <div class="row">
      <div class="col-md-4 top-page-flag-darkgreen">
